      ...
      >
        ...
        <button
          ...
          style={{
            ...
            background:
              activeFilterTag === null ? 'rgba(0,112,243,0.15)' : 'transparent',
        ...
        {allTags.map((tag) => {
          ...
          return (
            ...
            >
              <button
                onClick={() => onFilterTag(isFiltering ? null : tag.id)}
                style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  gap: '0.3rem',
              ...
              {linkId && (
                <button
                  ...
                  title={isAssigned ? 'Remove from link' : 'Add to link'}
                  style={{
                    padding: '0 0.3rem',
                    fontSize: '0.75rem',
                    background: 'none',
                    border: 'none',
                    color: isAssigned ? '#f87171' : '#4ade80',
                    cursor: 'pointer',
                  }}
                >
                  {isAssigned ? '−' : '+'}
